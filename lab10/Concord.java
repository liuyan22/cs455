...
public class Concord {
    ...
    public void printSorted(PrintStream out) {
        ArrayList<Map.Entry<String,Integer>> concordList = new ArrayList(concord.entrySet());
        Collections.sort(concordList, new Comparator<Map.Entry<String, Integer>>(){
            @Override
        ...
        for(Map.Entry<String, Integer> curr : concordList){
            out.println(curr.getKey() + " " + curr.getValue());
        }
    }
